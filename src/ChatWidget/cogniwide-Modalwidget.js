...
class ModalWidget extends React.Component {
  ...
  render() {
    return (
      <div
        id='myModal'
        className={`cog_chat_modal ${this.props.isModalOpen ? 'displayModal' : ''}`}
      >
        <div
          ...
          {this.state.isConfirmed ? (
              ...
              >
                ...
                <div className='cog_chat_modal-chat-content'>
                  <div className='cog_chat_header'>
                    ...
                    <div className='cog_chat_title'>Chat - Awnic</div>
            ...
            <div className='confirm-box'>
              ...
              >
                ...
                <img src={modalBotAvatar} className='botImg' alt='bot-img'></img>
              </div>
